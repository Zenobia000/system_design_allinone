...
## Learning Goal
讓學員掌握五種韌性手法的名稱和定義，理解每種手法解決的問題類型，為 slide-06 FMEA 表的「緩解手法」欄位建立詞彙。
