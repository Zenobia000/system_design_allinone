...
- VCRE four-card row (horizontal, equal width, rounded 16 px, spacing 20 px, spanning ~90% width):
  - Card V (商業價值): background `#152238`. Top: `V` Inter 800 / 48 px / Mint `#97E8D6`. Mid: `商業價值` Noto Sans TC 700 / 34 px / Warm White. Sub: `Value` JetBrains Mono 500 / 26 px / Mint `#97E8D6`. Bottom: `這決策賺錢/省錢/降風險嗎？` Noto Sans TC 500 / 26 px / Warm White / line-height 1.40. Example caption (below the question): `例：告警快→少賠停機損失` Noto Sans TC 400 / 22 px / Mint `#97E8D6` / line-height 1.30.
  - Card C (成本): background `#2E7D86`. Top: `C` Inter 800 / 48 px / Warm White. Mid: `成本` Noto Sans TC 700 / 34 px / Warm White. Sub: `Cost TCO` JetBrains Mono / 26 px / Mint `#97E8D6`. Bottom: `雲費＋人力＋維運總和？` Noto Sans TC 500 / 26 px / Warm White. Example caption (below the question): `例：雲費＋人力，月控 $5,000` Noto Sans TC 400 / 22 px / Mint `#97E8D6` / line-height 1.30.
  - Card R (風險): background `#152238`. Top: `R` Inter 800 / 48 px / Mint `#97E8D6`. Mid: `風險` Noto Sans TC 700 / 34 px / Warm White. Sub: `Risk` JetBrains Mono / 26 px / Mint `#97E8D6`. Bottom: `SPOF 在哪？十倍流量撐得住？` Noto Sans TC 500 / 26 px / Warm White. Example caption (below the question): `例：TSDB 單點掛＝全黑` Noto Sans TC 400 / 22 px / Mint `#97E8D6` / line-height 1.30.
  - Card E (可演進): background `#2E7D86`. Top: `E` Inter 800 / 48 px / Warm White. Mid: `可演進` Noto Sans TC 700 / 34 px / Warm White. Sub: `Evolvability` JetBrains Mono / 26 px / Mint `#97E8D6`. Bottom: `三年後要改，會被卡住嗎？` Noto Sans TC 500 / 26 px / Warm White. Example caption (below the question): `例：先 monolith，後拆服務` Noto Sans TC 400 / 22 px / Mint `#97E8D6` / line-height 1.30.
...
## GPT Image Prompt
Create a 1920x1080 horizontal PowerPoint educational slide for "架構師 101" course. Background: Warm White #F4F1EA. Brand colors only: #152238, #F4F1EA, #2E7D86, #97E8D6, #E8634F. Top-left: "METHOD" pill badge Deep Teal #2E7D86, Warm White text. Title "VCRE 計分卡" in Noto Sans TC 900 / 80 px / Deep Navy #152238, left-aligned. Center: four equal horizontal cards (rounded 16 px, spacing 20 px, ~90% width total), left to right exactly as follows. Card 1 (background Deep Navy #152238): big letter "V" at top, Chinese name "商業價值" in middle, English "Value" in JetBrains Mono, bottom question "這決策賺錢/省錢/降風險嗎？", then a smaller Mint example caption below the question reading exactly "例：告警快→少賠停機損失". Card 2 (background Deep Teal #2E7D86): big letter "C", Chinese name "成本", English "Cost TCO" in JetBrains Mono, bottom question "雲費＋人力＋維運總和？", then a smaller Mint example caption reading exactly "例：雲費＋人力，月控 $5,000". Card 3 (background Deep Navy #152238): big letter "R", Chinese name "風險", English "Risk" in JetBrains Mono, bottom question "SPOF 在哪？十倍流量撐得住？", then a smaller Mint example caption reading exactly "例：TSDB 單點掛＝全黑". Card 4 (background Deep Teal #2E7D86): big letter "E", Chinese name "可演進", English "Evolvability" in JetBrains Mono, bottom question "三年後要改，會被卡住嗎？", then a smaller Mint example caption reading exactly "例：先 monolith，後拆服務". In every card: letter at top (Inter 800), Chinese name (Noto Sans TC 700), English name below it, one-line question, then one small Mint #97E8D6 example caption (22 px) at the very bottom — text in Warm White with Mint #97E8D6 accents on the letter, English name, and example caption. Below cards: caption "沒有最好的答案，只有取捨。" in Deep Navy 26 px. Bottom-right corner: keep it clean and completely empty (reserved for a brand logo overlaid later) — do not draw any logo, emblem, badge, monogram, or icon there. Footer "桑尼資料科學 · 版權所有 ©" 22 px Deep Navy at bottom-left. Balanced, tool-like presentation.
...
- Do not add more than one example caption (the "例：…" line) per card, and do not invent example text other than the exact caption specified for each card.
