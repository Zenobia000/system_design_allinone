...
- Gloss note (small, near tech stack table or ADR block), two lines:
  - Line 1: `Hypertable＝TimescaleDB 按時間自動切塊的表`
  - Line 2: `按時間切塊＝加速時間查詢`
