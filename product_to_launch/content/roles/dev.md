...
ai_can: "boilerplate、unit test、error handling、refactor、bug 重現 script"
ai_cannot: "驗證它寫的對不對、邊界會不會崩、上線後有沒有 regression"
human_decides: "這段該重構還是接受技術債？AI 給的 code 要全收還是只收 60%？"
