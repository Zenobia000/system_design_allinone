...
ai_can: "從 PRD 生 test case 矩陣、edge case 假設、自動化腳本"
ai_cannot: "explorative testing、risk-based testing；不知道客服半夜接客訴有多痛"
human_decides: "哪個 bug 阻擋上線？哪些 case 是 must test、哪些只是 nice？"
